...
0210: FD 21 47 60   ld   iy,player_just_moved_flag_6047
...
021E: CD 10 10      call handle_player_object_carry_1010
0221: CD 4B 10      call $104B
0224: 3E 01         ld   a,$01
0226: 32 8A 62      ld   (unknown_628A),a
0229: 3A 0D 60      ld   a,(player_screen_600D)
022C: 32 98 60      ld   (current_guard_screen_index_6098),a
...
0246: 32 98 60      ld   (current_guard_screen_index_6098),a
...
0266: 32 98 60      ld   (current_guard_screen_index_6098),a
...
029A: CD 6F 11      call guard_1_walk_movement_116F
...
02FF: 32 98 60      ld   (current_guard_screen_index_6098),a
...
030F: 3A 97 60      ld   a,(guard_2_not_moving_timeout_counter_6097)
0312: 3C            inc  a
0313: 32 97 60      ld   (guard_2_not_moving_timeout_counter_6097),a
0316: FD 21 8F 60   ld   iy,unknown_608F
031A: 21 77 60      ld   hl,guard_2_in_elevator_6077
...
032B: 32 98 60      ld   (current_guard_screen_index_6098),a
...
033D: 32 98 60      ld   (current_guard_screen_index_6098),a
0340: 21 3B 60      ld   hl,guard_1_in_elevator_603B
0343: DD 21 94 65   ld   ix,guard_1_struct_6594
0347: CD 27 0A      call $0A27
034A: 3A 57 60      ld   a,(guard_1_not_moving_timeout_counter_6057)
034D: 3C            inc  a
034E: 32 57 60      ld   (guard_1_not_moving_timeout_counter_6057),a
0351: FD 21 4F 60   ld   iy,unknown_604F
0355: 21 37 60      ld   hl,guard_1_in_elevator_6037
...
0366: 32 98 60      ld   (current_guard_screen_index_6098),a
...
03E0: 32 98 60      ld   (current_guard_screen_index_6098),a
...
064F: 3A 98 60      ld   a,(current_guard_screen_index_6098)
0652: 3C            inc  a
...
0668: 3A 98 60      ld   a,(current_guard_screen_index_6098)
066B: 3D            dec  a
066C: 32 98 60      ld   (current_guard_screen_index_6098),a
066F: AF            xor  a
...
0A09: 3A 98 60      ld   a,(current_guard_screen_index_6098)
0A0C: FE 01         cp   $01
...
0A27: 3A 98 60      ld   a,(current_guard_screen_index_6098)
0A2A: FE 02         cp   $02
...
0B4B: 3E 0D         ld   a,$0D
0B4D: 47            ld   b,a
0B4E: 3A 98 60      ld   a,(current_guard_screen_index_6098)
0B51: B8            cp   b
0B52: C0            ret  nz
0B53: 3E 01         ld   a,$01
...
handle_player_object_carry_1010:
...
1194: 3A 98 60      ld   a,(current_guard_screen_index_6098)
...
11C0: 3A 98 60      ld   a,(current_guard_screen_index_6098)
...
1232: CD 57 29      call init_guard_directions_and_wagons_2957
1235: AF            xor  a
...
1369: 32 98 60      ld   (current_guard_screen_index_6098),a
...
13A6: 3A 57 60      ld   a,(guard_1_not_moving_timeout_counter_6057)
13A9: FE F0         cp   $F0
13AB: D4 A3 31      call nc,maybe_guard_1_is_stuck_31a3
13AE: FE 10         cp   $10     ; test now decide later at 13D0
...
13D6: 32 98 60      ld   (current_guard_screen_index_6098),a
...
141C: 3A 97 60      ld   a,(guard_2_not_moving_timeout_counter_6097)
141F: FE F0         cp   $F0
	; guard is not moving for a very long time, check if not stuck somewhere
	; (which would be a game bug but at least the guards will reset)
1421: D4 C1 31      call nc,maybe_guard_2_is_stuck_31c1
1424: FE 10         cp   $10
...
1442: DD 21 75 60   ld   ix,guard_2_ladder_frame_6075
	...
	; and request a direction change
...
1453: 18 05         jr   $145A
1455: 3E 01         ld   a,$01
1457: 32 77 60      ld   (guard_2_in_elevator_6077),a
...
1462: 18 05         jr   $1469
1464: 3E 01         ld   a,$01
1466: 32 37 60      ld   (guard_1_in_elevator_6037),a
1469: 2A 38 60      ld   hl,(guard_1_logical_address_6038)
146C: FD 21 37 60   ld   iy,guard_1_in_elevator_6037
...
150E: 32 98 60      ld   (current_guard_screen_index_6098),a
...
1677: 32 98 60      ld   (current_guard_screen_index_6098),a
167A: DD E1         pop  ix
167C: FD E1         pop  iy
167E: C1            pop  bc
167F: F1            pop  af
...
169B: 32 98 60      ld   (current_guard_screen_index_6098),a
...
16D8: 32 98 60      ld   (current_guard_screen_index_6098),a
...
check_for_not_moving_timeout_1908:
...
197A: 32 98 60      ld   (current_guard_screen_index_6098),a
...
1A01: 3A 98 60      ld   a,(current_guard_screen_index_6098) ; guard screen
1A04: 47            ld   b,a
1A05: 3A 0D 60      ld   a,(player_screen_600D)
1A08: B8            cp   b
1A09: 28 03         jr   z,$1A0E
	;; not same screen as player
1A0B: CD BD 1B      call guide_guard_on_hidden_screen_1bbd
...
1A2A: 3A 47 60      ld   a,(player_just_moved_flag_6047)
1A2D: FE 00         cp   $00
...
1BBC: C9            ret
	...
	;; < b:	guard screen
guide_guard_on_hidden_screen_1bbd:
1BBD: DD E5         push ix
1BBF: FD E5         push iy
1BC1: E5            push hl
1BC2: C5            push bc
...
1D7D: FE 01         cp   $01
1D7F: CA 50 1F      jp   z,player_dies_1f50
1D82: AF            xor  a
1D83: C9            ret
...
1E74: CD 50 1F      call player_dies_1f50
1E77: 3E 01         ld   a,$01
1E79: C9            ret
...
1EFD: AF            xor  a
1EFE: 32 97 60      ld   (guard_2_not_moving_timeout_counter_6097),a
...
1F13: 32 77 60      ld   (guard_2_in_elevator_6077),a
...
2009: 32 77 60      ld   (guard_2_in_elevator_6077),a
200C: 32 37 60      ld   (guard_1_in_elevator_6037),a
200F: 32 4F 60      ld   (unknown_604F),a
2012: CD 57 29      call init_guard_directions_and_wagons_2957
2015: 3E 01         ld   a,$01
2017: C9            ret
...
224E: 32 98 60      ld   (current_guard_screen_index_6098),a
2251: DD E5         push ix
...
2264: AF            xor  a
2265: 32 57 60      ld   (guard_1_not_moving_timeout_counter_6057),a
2268: 3E 21         ld   a,$21
226A: 32 94 65      ld   (guard_1_struct_6594),a
226D: 2A 38 60      ld   hl,(guard_1_logical_address_6038)
2270: FD 21 37 60   ld   iy,guard_1_in_elevator_6037
...
2289: 32 98 60      ld   (current_guard_screen_index_6098),a
228C: DD E5         push ix
...
init_guard_directions_and_wagons_2957:
2957: 3E 01         ld   a,$01
...
;;; check if guard must wait for the elevator
	...
	;; params:
;;;  current_guard_screen_index_6098:	current guard screen
;;;  ix:	player struct
...
2AFA: 3A 98 60      ld   a,(current_guard_screen_index_6098)
2AFD: 47            ld   b,a
...
2BA6: 3E 01         ld   a,$01
2BA8: 77            ld   (hl),a
2BA9: 3A 98 60      ld   a,(current_guard_screen_index_6098)
2BAC: FE 02         cp   $02
...
2BD1: 3A 98 60      ld   a,(current_guard_screen_index_6098)
2BD4: FE 03         cp   $03
...
2CAC: 3E 01         ld   a,$01
2CAE: 32 37 60      ld   (guard_1_in_elevator_6037),a
...
2CCA: 3E 01         ld   a,$01
2CCC: 32 77 60      ld   (guard_2_in_elevator_6077),a
...
32EB: CD 4E 36      call move_guard_1_96_times_364e
32EE: 18 0A         jr   $32FA
32F0: DD 7E 02      ld   a,(ix+$02)
32F3: FE 26         cp   $26
32F5: 30 03         jr   nc,$32FA
32F7: CD 4E 36      call l_364e
...
3312: CD 58 36      call move_guard_2_96_times_3658
3315: 18 0A         jr   $3321
3317: DD 7E 02      ld   a,(ix+$02)
331A: FE 10         cp   $10
331C: 30 03         jr   nc,$3321
331E: CD 58 36      call move_guard_2_96_times_3658
...
3637: C9            ret
	...
	;; no more info
move_guard_1_96_times_364e:
364E: 06 60         ld   b,$60
3650: C5            push bc
3651: CD 6F 11      call guard_1_walk_movement_116F
3654: C1            pop  bc
...
3658: 06 60         ld   b,$60
365A: C5            push bc
365B: CD 9B 11      call guard_2_walk_movement_119B
365E: C1            pop  bc
...
3C5F: 3A 98 60      ld   a,(current_guard_screen_index_6098)
...
3CDC: AF            xor  a
3CDD: 32 77 60      ld   (guard_2_in_elevator_6077),a
...
3D16: AF            xor  a
3D17: 32 37 60      ld   (guard_1_in_elevator_6037),a
...
3D3F: 32 98 60      ld   (current_guard_screen_index_6098),a
...
3DD7: 3A 98 60      ld   a,(current_guard_screen_index_6098)
3DDA: 47            ld   b,a
